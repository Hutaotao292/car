...
//================================================定义 MT9V03X 参数配置================================================
#define MT9V03X_WS               (188)                                           // 图像宽度     范围 [1-752]
#define MT9V03X_HS               (90)                                           // 图像高度     范围 [1-480]
#define MT9V03X_W               (188)                                           // 图像宽度     范围 [1-752]
#define MT9V03X_H               (90)                                           // 图像高度     范围 [1-480]

#define MT9V03X_IMAGE_SIZE      (MT9V03X_WS * MT9V03X_HS)                         // 整体图像大小不能超过 65535

#define MT9V03X_AUTO_EXP_DEF    ( 48 )                                         // 自动曝光设置     默认不开启自动曝光设置  范围 [0-63] 0为关闭
...
extern uint8    mt9v03x_image[MT9V03X_HS][MT9V03X_WS];                            // 图像数据存储数组
extern uint8    gray_image[45][94];
extern uint8    binary_image[45][94];
extern uint8    binary_image_bak[45][94];
extern uint8    contrast_image[45][94];
extern uint8    gray_binary_image[45][94];
//================================================声明 MT9V03X 全局变量================================================
